...
@section('content')
    ...
    <main class="flex text-center rounded-full justify-center align-middle mt-8 mb-28">
        <div class="bg-indigo-400 p-10 border-4 border-indigo-500 rounded-lg">
            <h1 class="text-center text-3xl font-bold text-white pb-5 mb-5 border-b-2">Create Invitation</h1>
            <form action="{{ route('invitation.store') }}" method="post" enctype="multipart/form-data">
                ...
                <label for="Body" class="text-center text-2xl font-bold text-white">Description</label>
                ...
                <label for="attachment" class="text-center text-2xl font-bold text-white">Attachment</label>
