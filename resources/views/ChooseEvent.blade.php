    ...
    <main class="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        ...
        <div class="flex text-center rounded-full justify-center">
            ...
            <div class="bg-indigo-400 py-10 px-28 border-4 border-indigo-500 rounded-lg ">
                ...
                <!-- selecting the event -->
                <label for="Event" class="text-center text-3xl text-white font-bold">Events</label>
                <h3 class="text-xl text-gray-500 font-semibold">Choose an event</h3><br>
                @if(isset($Inv))
                ...
                @endif
                    ...
                    @if(isset($Inv))
                        ...
                        <span class="text-center text-white text-lg font-semibold group-hover:text-indigo-500">Find Event's Invitation</span>
                        </button>
                    @elseif(isset($Camp))
                        <button type="submit" class="focus:ring-0 w-full border-4 border-white rounded-3xl px-8 py-1 hover:bg-white group  ">
                        <span class="text-center text-white text-lg font-semibold group-hover:text-indigo-500">Find Event's Campaigns</span>
                        </button>
                    @elseif(isset($type))
                        <button type="submit" class="focus:ring-0 w-full border-4 border-white rounded-3xl px-8 py-1 hover:bg-white group  ">
                        <span class="text-center text-white text-lg font-semibold group-hover:text-indigo-500">Find Event's Statistics</span>
                        </button>
                    @endif
